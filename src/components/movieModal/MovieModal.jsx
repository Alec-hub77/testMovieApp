...
const MovieModal = ({ setShowModal }) => {
  return (
    <div className="movie_modal">
      <div className="movie_modal_top">
        <div onClick={() => setShowModal(false)} className="close_btn">
          <IoCloseCircleOutline />
        </div>
        <div className="poster">
          <img
            src="https://m.media-amazon.com/images/M/MV5BMTc0ZjQ5ODctYzRmNC00ZjQ3LWFlZDctN2NjNjY1MTliMjU3L2ltYWdlL2ltYWdlXkEyXkFqcGdeQXVyNjkxMjM5Nzc@._V1_SX300.jpg"
            alt=""
          />
        </div>
      ...
      <div className="movie_modal_bottom">
        ...
        <div className="video_description">
          ...
          adipisci molestiae obcaecati dolorum accusantium quidem totam id
          cupiditate dolor blanditiis.
        </div>
        <div className="video_cast">Cast:</div>
        <span>
          Peter Dinklage, Nikolaj Coster-Waldau, Lena Headey, Kit Harington
        </span>
      </div>
    </div>
  );
